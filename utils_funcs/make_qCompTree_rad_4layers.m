function Q = make_qCompTree_rad_4layers(q0,q_children,sk,b00, beta0_rad, beta_rad)
...
Q = orderfields(Q,{'t_paras','s','q0','T0_pointNum','len0', 'K_sideNum','q','T_sidePointNums','len', ...
