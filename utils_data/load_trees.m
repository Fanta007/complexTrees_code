function [allTrees] = load_trees(data_path)
...
% --- this function convert the orginal raw data to layer-representation
    compTrees{i} = compTree_from_swcdata(raw_trees{i}, 4);  
...
%%
qCompTree_1 = ComplexTree_to_qComplexTree_4layers(compTrees{90});
qCompTree_2 = ComplexTree_to_qComplexTree_4layers(compTrees{97});
