function [all_qCompTrees, compTrees] = load_symNeuroTrees_rad(data_path)
...
for i=1:tree_num
    ...
    % mirror symmetrize raw_tree{i} as to Y aixs
    raw_trees{i} = raw_trees{i}.* repmat([1, 1, -1, 1, 1, 1, 1], size(raw_trees{i},1), 1);  % [~, ~, x, y, z, r, ~]
