...
% Compute tree infomation: total layers and branch amounts
for i=1:numel(all_compTrees)
    [amount_layer(i), amount_branch(i)]= Compute_treeInfo(all_compTrees{i});
end

disp(amount_layer)
disp(amount_branch)

% run showAll_compBotanTrees_4layers_withTreeInfo.m
run showAll_compTrees_4layers_withTreeInfo.m
return
