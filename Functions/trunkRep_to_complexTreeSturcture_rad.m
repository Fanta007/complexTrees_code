function [ST_1] = trunkRep_to_complexTreeSturcture_rad(trunk1)
...
for i = 1: numel(trunk1.children)
    ...
    ST_1.beta_children{i} = trunkRep_to_simpleTreeSturcture_rad(trunk1.children{i});
    ...
    for j = 1: numel(ST_1.beta_children{i}.beta_children)
        ...
        F = spline(t_paras, Beta0(4, :));
        
        data_t_parasAndRad = [t_paras; Beta0(4, :)];
