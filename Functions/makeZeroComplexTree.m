function q_zero = makeZeroComplexTree(q_children)


q_zero.t_paras = q_children.t_paras;
q_zero.s = q_children.s;
q_zero.q0 = zeros(size(q_children.q0, 1), numel(q_zero.t_paras));
...
q_zero.data_t_parasAndRad = [];

% --- Here change the field of t_paras to make it safe ---
