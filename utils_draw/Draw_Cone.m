 function [Cone,EndPlate1,EndPlate2] = Draw_Cone(X1,X2,R,n,cyl_color,closed,lines)
%
...
set(Cone,'AmbientStrength',1,'FaceColor',cyl_color,'FaceLighting','gouraud','EdgeColor','b')
if closed==1
    set([EndPlate1 EndPlate2],'AmbientStrength',1,'FaceColor',cyl_color,'FaceLighting','gouraud','EdgeColor','b')
else
    EndPlate1=[];
    EndPlate2=[];
end
