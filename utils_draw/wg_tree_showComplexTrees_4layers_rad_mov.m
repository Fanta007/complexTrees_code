clc
close all;
video_name = ['Geodesic_', num2str(16), '-', num2str(20), '.avi'];
...
%     plot3(X0 -first_pt_x + x_added, Y0 - first_pt_y + y_added, Z0 - first_pt_z, 'Color',c(1,:), 'LineWidth', 2); hold on;
...
%     count = count+1;
    ...
    for j=1: numel(CT{i}.beta)
        ...
        X0 = CT{i}.beta{j}(1, :)- first_pt_x + x_added;
        Y0 = CT{i}.beta{j}(2, :)- first_pt_y + y_added;
        Z0 = CT{i}.beta{j}(3, :)- first_pt_z;
        R0 = CT{i}.beta{j}(4, :);
