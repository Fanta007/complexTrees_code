...
for i=1: numel(CT)
    ...
    y_added = ceil(i/10) * (-10);
    x_added = (mod(i-1, 10)) * 5;
    ...
    text(X0(1), Y0(1)-1, Z0(1), ['L:', num2str(amount_layer(i))], 'FontSize', 10);
    text(X0(1), Y0(1)-2, Z0(1), ['B:', num2str(amount_branch(i))], 'FontSize', 10);
...
saveas(gcf,'All_compBotanTrees_4layers_with.png')
