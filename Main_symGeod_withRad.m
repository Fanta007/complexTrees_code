...
% [all_qCompTrees_sym, all_compTrees_sym] = load_symBotanTrees_rad(data_path);
% % 
% addpath('utils_draw')
...
[all_qCompTrees_sym, all_compTrees_sym] = load_symNeuroTrees_rad(data_path);
...
% ===== Pad and Align trees =====
tm1 = tic;
[G,Q1p, Q2p] = ReparamPerm_qCompTrees_rad_4layers_v2_forSym(Q1, Q2, lam_m, lam_s, lam_p);
...
% % ===== Save Objs =====
addpath('GetOBJ')
obj_folder = saveGeoObjs_compTrees_rad_4layers(A10, ['Sym_',data_path], idx1, idx2);
